...
Precio_compra REAL,Vendedor TEXT,
Fecha_compra TEXT,
Criadero TEXT,Procedencia_otro TEXT,
Procedencia_otro_cual TEXT,
Procedencia_otro_notas TEXT,Vendida TEXT,
Vendida_comprador TEXT,
Vendida_precio REAL,Vendida_fecha TEXT,
Muerta TEXT,Muerta_causa TEXT,
Muerta_fecha TEXT)
"""
...
Tipo TEXT,
Fecha TEXT,
FOREIGN KEY(Numero) REFERENCES ganado(Numero) 
ON DELETE CASCADE
ON UPDATE CASCADE)
"""
